...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* //val df = SimpleDateFormat("EEE, d MMM yyyy, HH:mm") 2019/03/05 23:14:05
         val df = SimpleDateFormat("yyyy/MM/dd HH:mm:ss")
         val date = df.format(Calendar.getInstance().getTime())
         Log.e("Time ", date)*/
        //  setLunchDinnerTimings()
        //Log.e("File Test ", checkURL(stringFile).toString())
        // Log.e("Url Test ", checkURL(stringUrl).toString())
        try {
